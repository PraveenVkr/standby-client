  ...
  return (
    <div className="flex h-screen">
      <div className="bg-white w-1/3 flex flex-col">
        ...
        <div className="p-2 text-center flex items-center justify-left gap-1">
          ...
          <button
            onClick={logout}
            className="text-sm bg-gray-800 py-1.5 px-2.5 text-white border rounded flex items-center space-x-1"
          >
            <span>logout</span>
            <RiLogoutBoxRFill />
          </button>
